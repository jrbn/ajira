...
public class ReadFromBucket extends Action {
	...
	/**
	 * The <code>I_BUCKET_ID</code> parameter, of type <code>int</code>, is required,
	 * and represents the number of the bucket to obtain the input tuples from.
	 */
	public static final int I_BUCKET_ID = 0;
	
	/**
	 * The <code>I_NODE_ID</code> parameter, of type <code>int</code>, is not required.
	 * It either specifies a node number, on which the chain is to be executed, or
	 * -1, in which case the chain is executed on all nodes. The default value is -1.
	 */
