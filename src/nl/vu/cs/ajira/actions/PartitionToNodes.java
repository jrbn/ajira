...
public class PartitionToNodes extends Action {
	...
	/**
	 *  The <code>B_SORT</code> parameter is of type <code>boolean</code>, is not required, and defaults
	 *  to <code>false</code>. When set, the resulting partitions will be sorted.
	 */
	public static final int B_SORT = 0;
	
	/**
	 * The <code>S_PARTITIONER</code> parameter is of type <code>String</code>, is not required, and
	...
	/**
	 * The <code>I_NPARTITIONS_PER_NODE</code> parameter is of type <code>int</code>, is not required,
	...
	/**
	 * The <code>IA_BUCKET_IDS</code> parameter is of type {@link TIntArray} and is not required.
	...
	/**
	 * The <code>IA_SORTING_FIELDS</code> parameter is of type <code>int[]</code>, is not required,
	 ...
	 * int array contains <code>{2, 0}</code>, the sorting will use field 2 and field 0, in that
	...
	/**
	 * The <code>IA_PARTITION_FIELDS</code> parameter is of type <code>int[]</code>, and is not required.
	...
	public void registerActionParameters(ActionConf conf) {
		...
		conf.registerParameter(I_NPARTITIONS_PER_NODE, "I_NPARTITIONS_PER_NODE",
				null, false);
		...
		conf.registerParameter(IA_PARTITION_FIELDS, "IA_PARTITION_FIELDS", null,
				false);
